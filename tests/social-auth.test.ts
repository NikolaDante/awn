...
test("repeated social sign-in resolves the immutable creator-owned private plan", () => {
  assert.match(source("lib/cloud-financial-repository.ts"), /rpc\("awn_resolve_private_household"/);
