...
type PlanSearchParams = Promise<{ tab?: string | string[]; action?: string | string[]; scope?: string | string[] }>;
...
export default async function PlanPage({ searchParams }: { searchParams: PlanSearchParams }) {
  ...
  return <div className="app-page plan-page"><PageHeader title="Plan" eyebrow="Budgets and goals" /><PlanView initialTab={view.tab} initialAction={view.action} initialScope={view.scope} /></div>;
}
